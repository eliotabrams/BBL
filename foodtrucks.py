...
#import os
#os.chdir('/Users/eliotabrams/Desktop')

from BBL_grid import *
...
# Drop weekends
location_data = location_data[pd.to_datetime(location_data['Date']).dt.weekday < 5]
...
# Reset truck types so DataFrame only contains trucks present in the cleaned data
